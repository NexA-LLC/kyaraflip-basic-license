---
name: kyaraflip-basic-license
purpose: "このリポジトリは **KyaraFlip 基本ライセンス（KFL）** の正本（canonical）です。"
version: 1
...
## IDENTITY
- Product identity: `kyaraflip-basic-license`.
...
## CAPABILITIES
- Current strengths:
- Core stack detected: General application stack.
- todos.jsonl is present for queue-oriented task tracking.
- Current blind spots:
- Test coverage signals are weak or missing.
- Documentation surface is thin; implementation intent may drift.
...
|------|---------|--------|--------|--------|
| 2026-03-09 | 1 | Initial SOUL baseline generated (General application stack) | Nariya Takemura | pending |
